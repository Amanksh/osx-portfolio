...
export default function Window({
  ...
  return (
    ...
    >
      {/* Window title bar */}
      <div
        className="h-8 bg-gradient-to-r from-purple-600 to-pink-600 border-b border-navy-700 flex items-center px-3 select-none"
      ...
      >
        ...
        <div className="text-xs font-medium text-center flex-1 text-white">
          {title}
        </div>
      </div>
